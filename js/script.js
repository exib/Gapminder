...
const selrr = d3.select('#radius');
params.forEach(function(d) {
    let op = selrr.append('option')
        .attr('id', d);
    if (d === radius) {
...
const selectX = d3.select('#xParam');
params.forEach(function(d) {
    let opt = selectX.append('option')
        .attr('id', d);
    if (d === xParam) {
...
const selectY = d3.select('#yParam');
params.forEach(function(d) {
    let opt = selectY.append('option')
        .attr('id', d);
    if (d === yParam) {
